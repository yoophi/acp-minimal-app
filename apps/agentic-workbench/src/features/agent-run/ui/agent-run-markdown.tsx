  ...
  return (
    <Dialog open={expandedOpen} onOpenChange={setExpandedOpen}>
      ...
      <DialogContent className="grid h-[calc(100dvh-2rem)] max-h-[calc(100dvh-2rem)] w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] grid-rows-[auto_minmax(0,1fr)] gap-3 overflow-hidden p-4 sm:max-w-[calc(100vw-2rem)]">
        ...
        <div className="min-h-0 min-w-0 overflow-hidden rounded-md border bg-background p-3 [&_.markdown-viewer__mermaid]:my-0 [&_.markdown-viewer__mermaid]:flex [&_.markdown-viewer__mermaid]:h-full [&_.markdown-viewer__mermaid]:max-h-none [&_.markdown-viewer__mermaid]:w-full [&_.markdown-viewer__mermaid]:items-center [&_.markdown-viewer__mermaid]:justify-center [&_.markdown-viewer__mermaid]:overflow-hidden [&_.markdown-viewer__mermaid]:border-0 [&_.markdown-viewer__mermaid]:p-0 [&_.markdown-viewer__mermaid>div]:flex [&_.markdown-viewer__mermaid>div]:h-full [&_.markdown-viewer__mermaid>div]:w-full [&_.markdown-viewer__mermaid>div]:items-center [&_.markdown-viewer__mermaid>div]:justify-center [&_.markdown-viewer__mermaid_svg]:h-auto [&_.markdown-viewer__mermaid_svg]:max-h-full [&_.markdown-viewer__mermaid_svg]:max-w-full">
